...
class Header extends Widget {
    public static createNode(): HTMLElement {
        ...
        light.onclick = () => {
            ...
            light.classList.add("active-icon");
            for (const c of (document.getElementsByClassName("PSPContainer-dark") as any as HTMLElement[])) {
        ...
        dark.onclick = () => {
            ...
            for (const c of (document.getElementsByClassName("PSPContainer") as any as HTMLElement[])) {
